...
$patients_data     = $patient_table->retrieve_all_patients_by_hospital_id($hospital_cur_data['id']);
////////////////// hospital data ////////////////////
...
$data = array();
                                ...
                                foreach ($patients_data as $single_patient) {
                                    ...
                                    $data['data'][] = [$doctor_name,$full_name,$age,$comment,$hospital,$report,$status];
                                }

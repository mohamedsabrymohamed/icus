                            ...
                            <div class="col">
                                <div class="card shadow mb-3">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 font-weight-bold">Pending Patients Data</p>
                                        <?php
                                        if (isset($_GET['success']) && $_GET['success'] == 'Y') {
                                            ?>
                                            <p style="text-align: center;color: limegreen;"><?php echo $_SESSION['change_patient_status_success']; ?></p>
                                        <?php } ?>
                                        <p id="error"></p>
                                    </div>
            ...
            <script>
                $(document).ready(function() {
                    var table = $('#example').DataTable( {
                        "pagingType": "input",
                        "lengthChange": false,
                        "ajax": 'tables_data/pending_patients_data.php',
                        "deferRender": true,
                        "processing": true,
                        dom: 'Bfrtip',
                        buttons: [
